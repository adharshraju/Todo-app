...
export class ManageTodoViewModel extends PageViewModel
{
    ...
    public set date(value: string) { this._date = value; }
    ...
    public async save(): Promise<void>
    {
        ...
        {
            if (this._todo)
                await this._todo.update(this._title, this._description, this._date);
            else
                await this._todoService.createTodo(this._title, this._description, this._date);
        }
        catch (e)
        {
            console.log(e);
